...
<meta name="viewport" content="width=device-width, initial-scale=1"/>
    ...
    <link href="{{HTMl::asset('css/bootstrap.min.css')}}" rel="stylesheet"/>
    <link href="{{HTML::asset('css/font-awesome.min.css')}}" rel="stylesheet"/>
    <link href="{{HTML::asset('css/main_styles.css')}}" rel="stylesheet"/>
    <link href="{{HTML::asset('css/responsive.css')}}" rel="stylesheet"/>
